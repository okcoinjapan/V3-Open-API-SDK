...
class AccountAPI(Client):
    ...
    # coin withdraw
    def coin_withdraw(self, currency, amount, to_address, trade_pwd, fee, reason, usage_agreement):
        params = {'currency': currency, 'amount': amount, 'to_address': to_address, 'trade_pwd': trade_pwd, 'fee': fee, 'reason': reason, 'usage_agreement': usage_agreement}
