...
class SpotAPI(Client):
    ...
    def get_trade_fee_all(self):
        return self._request_without_params(GET, SPOT_TRADE_FEE_ALL)

    def get_trade_fee_by_instrumentId(self, instrument_id):
            return self._request_without_params(GET, SPOT_TRADE_FEE_BY_INSTRUMENTID + str(instrument_id))
