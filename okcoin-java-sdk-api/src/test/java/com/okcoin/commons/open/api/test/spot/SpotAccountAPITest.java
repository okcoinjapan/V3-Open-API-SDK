...
import com.okcoin.commons.open.api.service.spot.SpotAccountAPIService;
import com.okcoin.commons.open.api.service.spot.impl.SpotAccountAPIServiceImpl;
...
public class SpotAccountAPITest extends SpotAPIBaseTests {
    ...
    public void getLedgersByCurrency() {
        final Object ledgers = this.spotAccountAPIService.getLedgersByCurrency("BTC", "", "", "100","");
