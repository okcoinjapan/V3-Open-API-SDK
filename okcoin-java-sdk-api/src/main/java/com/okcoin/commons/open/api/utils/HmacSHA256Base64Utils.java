package com.okcoin.commons.open.api.utils;

import com.okcoin.commons.open.api.constant.APIConstants;
import com.okcoin.commons.open.api.enums.AlgorithmEnum;
...
public class HmacSHA256Base64Utils {
     ...
     * @param body        json string, eg: {"product_id":"BTC-JPY-0309","order_id":"377454671037440"}
     ...
     * @param queryString eg: before=2&limit=30
     * @param body        json string, eg: {"product_id":"BTC-JPY-0309","order_id":"377454671037440"}
     * @return prehash string eg: 2018-03-08T10:59:25.789ZPOST/orders?before=2&limit=30{"product_id":"BTC-JPY-0309",
