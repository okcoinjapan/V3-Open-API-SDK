...
/*
 the pre hash string
  eg:
    ...
    body = {"product_id":"BTC-JPY","order_id":"377454671037440"}

  return pre hash string = 2018-03-08T10:59:25.789ZPOST/orders?before=2&limit=30{"product_id":"BTC-JPY","order_id":"377454671037440"}
*/
...
/*
 Get api requestPath + requestParams
	...
	params["start"] = "0"
	params["end"] = "2000"
	url := BuildParams("/api/spot/v3/instruments/ETC-JPY/candles", params)
 return eg:/api/spot/v3/instruments/ETC-JPY/candles?start=0&end=200
*/
